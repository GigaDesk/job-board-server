...
// PrimaryKeyName return the name of primarykey for Table School
func (d *SchoolFiltersInput) PrimaryKeyName() string {
	return "id"
}

// ExtendsDatabaseQuery create condition from SchoolFiltersInput values
func (d *SchoolFiltersInput) ExtendsDatabaseQuery(db *gorm.DB, alias string, deep bool, blackList map[string]struct{}) []runtimehelper.ConditionElement {
	res := make([]runtimehelper.ConditionElement, 0)
	if d.And != nil {
		tmp := make([]runtimehelper.ConditionElement, 0)
		for _, v := range d.And {
...
// ExtendsDatabaseQuery create condition from StudentFiltersInput values
func (d *StudentFiltersInput) ExtendsDatabaseQuery(db *gorm.DB, alias string, deep bool, blackList map[string]struct{}) []runtimehelper.ConditionElement {
	res := make([]runtimehelper.ConditionElement, 0)
	if d.And != nil {
		tmp := make([]runtimehelper.ConditionElement, 0)
		for _, v := range d.And {
	...
	if d.RegistrationNumber != nil {
		res = append(res, d.RegistrationNumber.ExtendsDatabaseQuery(db, fmt.Sprintf(extendsDatabaseFieldNameFormat, runtimehelper.GetQuoteChar(db), alias, "registration_number"), true, blackList)...)
	}
	if d.Name != nil {
		res = append(res, d.Name.ExtendsDatabaseQuery(db, fmt.Sprintf(extendsDatabaseFieldNameFormat, runtimehelper.GetQuoteChar(db), alias, "name"), true, blackList)...)
	}
	...
	if d.DateOfAdmission != nil {
		res = append(res, d.DateOfAdmission.ExtendsDatabaseQuery(db, fmt.Sprintf(extendsDatabaseFieldNameFormat, runtimehelper.GetQuoteChar(db), alias, "date_of_admission"), true, blackList)...)
	}
	if d.DateOfBirth != nil {
		res = append(res, d.DateOfBirth.ExtendsDatabaseQuery(db, fmt.Sprintf(extendsDatabaseFieldNameFormat, runtimehelper.GetQuoteChar(db), alias, "date_of_birth"), true, blackList)...)
	}
	if d.ProfilePicture != nil {
		res = append(res, d.ProfilePicture.ExtendsDatabaseQuery(db, fmt.Sprintf(extendsDatabaseFieldNameFormat, runtimehelper.GetQuoteChar(db), alias, "profile_picture"), true, blackList)...)
	}

	return res
}

// PrimaryKeyName return the name of primarykey for Table UnverifiedSchool
func (d *UnverifiedSchoolFiltersInput) PrimaryKeyName() string {
	return "id"
}

// ExtendsDatabaseQuery create condition from UnverifiedSchoolFiltersInput values
func (d *UnverifiedSchoolFiltersInput) ExtendsDatabaseQuery(db *gorm.DB, alias string, deep bool, blackList map[string]struct{}) []runtimehelper.ConditionElement {
	res := make([]runtimehelper.ConditionElement, 0)
	if d.And != nil {
		tmp := make([]runtimehelper.ConditionElement, 0)
		for _, v := range d.And {
